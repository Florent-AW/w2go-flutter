...
EventBase _$EventBaseFromJson(Map<String, dynamic> json) {
  return _EventBase.fromJson(json);
}
...
mixin _$EventBase {
  ...
  String? get wheelchairAccessible =>
      throw _privateConstructorUsedError; // 🎯 NOUVEAUX CHAMPS SPÉCIFIQUES AUX EVENTS
  ...
  /// Serializes this EventBase to a JSON map.
  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;

  /// Create a copy of EventBase
  /// with the given fields replaced by the non-null parameter values.
  @JsonKey(includeFromJson: false, includeToJson: false)
  $EventBaseCopyWith<EventBase> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $EventBaseCopyWith<$Res> {
  factory $EventBaseCopyWith(EventBase value, $Res Function(EventBase) then) =
      _$EventBaseCopyWithImpl<$Res, EventBase>;
  @useResult
  $Res call(
      {String id,
      String name,
...
/// @nodoc
class _$EventBaseCopyWithImpl<$Res, $Val extends EventBase>
    implements $EventBaseCopyWith<$Res> {
  _$EventBaseCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$EventBaseImplCopyWith<$Res>
    implements $EventBaseCopyWith<$Res> {
  factory _$$EventBaseImplCopyWith(
          _$EventBaseImpl value, $Res Function(_$EventBaseImpl) then) =
      __$$EventBaseImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String id,
...
/// @nodoc
class __$$EventBaseImplCopyWithImpl<$Res>
    extends _$EventBaseCopyWithImpl<$Res, _$EventBaseImpl>
    implements _$$EventBaseImplCopyWith<$Res> {
  __$$EventBaseImplCopyWithImpl(
      _$EventBaseImpl _value, $Res Function(_$EventBaseImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$EventBaseImpl implements _EventBase {
  const _$EventBaseImpl(
      {required this.id,
      required this.name,
  ...
  factory _$EventBaseImpl.fromJson(Map<String, dynamic> json) =>
      _$$EventBaseImplFromJson(json);
...
// 🎯 NOUVEAUX CHAMPS SPÉCIFIQUES AUX EVENTS
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$EventBaseImplCopyWith<_$EventBaseImpl> get copyWith =>
      __$$EventBaseImplCopyWithImpl<_$EventBaseImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$EventBaseImplToJson(
      this,
    );
  }
}

abstract class _EventBase implements EventBase {
  const factory _EventBase(
      ...
      final bool bookingRequired,
      final bool hasMultipleOccurrences,
      final bool isRecurring}) = _$EventBaseImpl;

  factory _EventBase.fromJson(Map<String, dynamic> json) =
      _$EventBaseImpl.fromJson;
  ...
  @override
  String? get wheelchairAccessible; // 🎯 NOUVEAUX CHAMPS SPÉCIFIQUES AUX EVENTS
  @override
